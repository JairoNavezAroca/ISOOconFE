  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-body">
      	...
      	<br>
        <input type="hidden" id="CodLibro" value="{{$libro['CodLibro']}}">
      	<div class="row form-group">
      		<div class="col-md-2"></div>
      		<div class="col-md-3"><label class="control-label">TitLibro</label></div>
      		<div class="col-md-5"><input type="text" id="TitLibro" class="form-control" value="{{$libro['TitLibro']}}"></div>
      		<div class="col-md-2"></div>
      	</div>
      	<div class="row form-group">
      		<div class="col-md-2"></div>
      		<div class="col-md-3"><label class="control-label">AnoLibro</label></div>
      		<div class="col-md-5"><input type="text" id="AnoLibro" class="form-control" value="{{$libro['AnoLibro']}}"></div>
      		<div class="col-md-2"></div>
      	</div>
        <div class="row form-group">
          <div class="col-md-2"></div>
